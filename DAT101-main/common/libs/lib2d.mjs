...
class TRectangle extends TPosition{
  ...
  isPositionInside(aPos){
    if(this.left >= aPos.right) return false;
    if(this.right <= aPos.left) return false;
    if(this.top >= aPos.bottom) return false;
    if(this.bottom <= aPos.top) return false;
    return true;
  }
