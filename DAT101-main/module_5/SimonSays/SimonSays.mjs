...
export const gameProps = {
  ...
  (spcvs,
    SpriteInfoList.ButtonStartEnd, SpriteInfoList.ButtonStartEnd.dst,
    lib2d.TCircle, 
  ),
  GameSpeed: 800,
...
function startGame(){
  ...
  gameProps.ColorButtons[0].sound = new libSound.TSoundWave(libSound.EOctave.Octave4, "C","sine" )//kan bare skrive tallet (4)
